---
title: "Graphs in R using ggplot2"
output:
...
<a href="https://lms.uwa.edu.au/bbcswebdav/pid-3355656-dt-content-rid-42740881_1/xid-42740881_1">
base-R graphics page</a>. Or, go to the 
[base-R graphics page](Learn_R-2023-Week_1a_graphs.html) if you're not 
interested in using `ggplot2`.
...
\@ref(fig:spm-ungrouped), we can see from the diagonal of density plots that all
...
> Go to the [base-R graphics page here](Learn_R-2023-Week_1a_graphs.html).
