...
<hr style="height: 3px; background-color: #660F00;" />
...
<hr style="height: 4px; background-color: #660F00;" />
...
```{r diagnostic-plots-grouped, fig.width=5, fig.height=5, fig.cap="Regression diagnostic plots for Cr predicted from Fe using a grouped linear regression model with different parameters for each sample Type", results='hold', echo=-3}
par(mfrow=c(2,2), mar=c(3,3,2,1))
...
### <span style="color: #A020F0; background-color: #fbeeb8;">More things to try (Correlation & regression Week 2)</span>
...
cor0[which(cor0==1)] <- NA
print(round(cor0,3), na.print = "")
rm(cor0)
```
