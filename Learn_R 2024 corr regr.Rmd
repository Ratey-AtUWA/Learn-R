...
If you need to install packages like `car`, `psych`, `lmtest`, and `effects`
...
>
> &mdash; [Stephen Jay Gould](https://en.wikipedia.org/wiki/Stephen_Jay_Gould){target="_blank"}
...
```{r correl-heat, fig.height=6, fig.width=6, message=FALSE, warning=FALSE, paged.print=FALSE, fig.cap="Correlation heatmap (Spearman) for selected variables in the 2023 Ashfield Flats sediment data. The numeric correlation matrix is below.", results='hold'}
