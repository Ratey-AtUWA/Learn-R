...
#                       crop = TRUE, zoom = 4)
# par(mfrow=c(1,2), oma=c(3,3,1,1),lheight=0.8, mgp=c(1.7,0.4,0), tcl=-0.2)
par(mfrow=c(1,1), mar=c(.1,.1,.1,.1), oma=c(.1,.1,.1,.1),
    lheight=0.8, mgp=c(1.7,0.4,0), tcl=-0.2)
# windowsFonts(nar="Arial Narrow")
# plot_tiles(USAtiles)
# mtext("Longitude (\u00B0)",1,1.7,font=2, cex=1.2)
# mtext("Latitude (\u00B0)",2,1.7,font=2, cex=1.2)
# axis(1); axis(2); box()
...
pic1 <- 
  readPNG("./Learn_R-2023-Week_1_basics_files/figure-html/hubbard-pix-x2.png")
plot(c(0,1),c(0,1), axes=F, type="n",xaxt="n", yaxt="n",ann=F)
addImg(pic1, x = 0.5, y = 0.5, width = 1)
# addImg(pic1, x = 0.5, y = 0.5, width = 1)
# mtext("Experimental sub-catchments at Hubbard Brook Experimental Forest.",
      # 1,0.4, cex=1.2)
```
