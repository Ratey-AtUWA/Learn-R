---
title: "Week 1 ENVT3361 Workshop"
output: 
...
text(c(rep(2.7,5),2), c(bps$stats, mean(bps$out)), pos=4, 
...
library(flextable)
flextable(data.frame(Statistic=row.names(mytable),mytable)) |>
  bold(bold=TRUE, part="header") |>
  set_caption(caption="Table created by the flextable R package. Many more table formatting options are available in this package.")
```
...
H. Wickham. *ggplot2: Elegant Graphics for Data Analysis*. Springer-Verlag New York, 2016. [https://ggplot2.tidyverse.org](https://ggplot2.tidyverse.org){target="_blank"}.
