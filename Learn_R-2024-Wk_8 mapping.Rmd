...
of packages. [*The Google maps key is owned by*
...
```{r ggAF, fig.height=4.5, fig.width=7.5, fig.align='center', fig.cap="Zinc concentration (mg/kg) in sediment sampled in Semester 1, 2021 at Ashfield Flats, Western Australia, plotted over Stamen toner-lite map tiles acquired using the R package ggmap, with data in a simple features data frame, and with manually added wetland pond locations.", out.width='70%', message=FALSE, warning=FALSE, results='hold'}
...
```{r stamen-watercolor, echo=FALSE, fig.align='center', fig.height=2.63, fig.width=7, message=FALSE, warning=FALSE, out.width='80%', results='hold'}
artextent <- st_as_sf(data.frame(x = c(115.814, 115.8925), 
                                 y = c(-31.9736, -31.9501)),
...
mtext("Thunderforest 'SpinalMap' of Kings Park and Perth", 3, -1.25, 
      col="white", family='mono', cex=1.2)
mtext("made with sf and maptiles", 1, -1.25, col="yellow", adj=0.98, cex=0.6, 
      family='mono')
text(115.86, -31.966, labels = "Swan River",
                fonte = 3, srt=350,
            cex = 1.4, hjust = 0.5, col="skyblue2")
text(115.832, -31.966, labels = "Kings\nPark",
       font=3, cex=1.4, col="#a0c090",srt=10) 
```
