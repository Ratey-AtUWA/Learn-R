...
```{r plot-map1-axes, fig.align='center', fig.cap="Map of Ashfield Flats in the UTM projection, generated using the maptiles R package, with OpenStreetMap tiles.", fig.width=8, fig.height=6, message=FALSE, warning=FALSE, out.width='70%', results='hold'}
aftiles <- maptiles::get_tiles(extent, provider = "OpenStreetMap.HOT", 
                               crop = TRUE, zoom=16)
par(oma=c(0,0,0,0), lend="square", xpd=TRUE)
plot_tiles(aftiles, adjust=F, axes=TRUE, mar=c(3,3,1,1))
# points(zk[,2:3], col="purple", pch=3, lwd=2)# use axes = TRUE

mtext("Longitude \u00B0E", side = 1, line = 3.2, font=2)
mtext("Latitude \u00B0N", side = 2, line = 2.3, font=2)
```
...
```{r map-north-scale, fig.align='center', fig.cap="Map of Ashfield Flats (UTM), with added North arrow and scale bar from prettymapr, over OpenStreetMap tiles acquired using maptiles.", fig.height=5, fig.width=8, message=FALSE, warning=FALSE, out.width='70%', results='hold',echo=FALSE}
par(oma=c(0,0,0,0), lend="square", xpd=TRUE)
...
```{r add-data, eval=TRUE, message=FALSE, warning=FALSE, out.width='70%',echo=FALSE, fig.height=5, fig.width=8, fig.cap = "Map of Ashfield Flats (UTM), with added North arrow, scale bar, and user data, over OpenStreetMap tiles acquired using maptiles.", fig.align='center', results='hold'}
par(oma=c(0,0,0,0), lend="square", xpd=TRUE)
plot_tiles(aftiles, adjust=F, axes=TRUE, mar=c(3,3,0.5,0.5)) # use axes = TRUE
...
```{r map-annot, error=FALSE, warning=FALSE, echo=FALSE, fig.height=5, fig.width=8, fig.align='center', out.width="70%", fig.cap="Map of Ashfield Flats (UTM), with added North arrow, scale bar, user data, and additional map items, over OpenStreetMap tiles acquired using maptiles.", results='hold'}
...
```{r map-text-labels, error=FALSE, warning=FALSE, echo=FALSE, fig.height=5, fig.width=8, fig.align='center', out.width="70%", fig.cap="Map of Ashfield Flats (UTM), with added North arrow, scale bar, user data, and additional map items plus text labels, over OpenStreetMap tiles acquired using maptiles.", results='hold'}
# everything we did above in the first line
par(oma=c(0,0,0,0), lend="square", xpd=TRUE)
plot_tiles(aftiles, adjust=F, axes=TRUE, mar=c(3,3,0.5,0.5)) # use axes = TRUE
...
```{r map-bubbles, fig.align='center', fig.cap="\\label{bubbles}Bubble map of zinc concentrations in sediment and soil at Ashfield Flats in 2019, over OpenStreetMap tiles acquired using maptiles.", fig.height=5, fig.width=8, message=FALSE, warning=FALSE, out.width='70%', results='hold'}
par(oma=c(0,0,0,0), lend="square", xpd=TRUE)
plot_tiles(aftiles, adjust=F, axes=TRUE, mar=c(3,3,0.5,0.5)) # use axes = TRUE
...
```{r PctBubb, fig.align='center', fig.cap="Map showing percentile ranges of zinc concentrations in sediment and soil at Ashfield Flats in 2019, over OpenStreetMap tiles acquired using maptiles.", out.width='70%', fig.height=6, fig.width=8, message=FALSE, warning=FALSE, results='hold'}
par(oma=c(0,0,0,0), lend="square", xpd=TRUE)
plot_tiles(aftiles, adjust=F, axes=TRUE, mar=c(3,3,0.5,0.5)) # use axes = TRUE
...
artStamen2 <- get_tiles(artextent, provider = "Thunderforest.SpinalMap",
                      apikey=secret[1,1], zoom=13,crop=TRUE)
