...
extent <- st_as_sf(data.frame(x=c(114.65,114.7),y=c(33.59,33.62)),
...
```{r plot-map1-axes, fig.align='center', fig.cap="Map of Ashfield Flats in the UTM projection, generated using the maptiles R package, with OpenStreetMap tiles.", fig.width=8, fig.height=5, message=FALSE, warning=FALSE, out.width='70%', results='hold'}
aftiles <- maptiles::get_tiles(extent, provider = "OpenStreetMap", crop = TRUE, 
                               zoom=17)
...
```{r PctBubb, fig.align='center', fig.cap="Map showing percentile ranges of zinc concentrations in sediment and soil at Ashfield Flats in 2019, over OpenStreetMap tiles acquired using maptiles.", out.width='70%', fig.height=5, fig.width=8, message=FALSE, warning=FALSE, results='hold'}
par(oma=c(0,0,0,0), lend="square", xpd=TRUE)
plot_tiles(aftiles, adjust=F, axes=TRUE, mar=c(3,3,0.5,0.5)) # use axes = TRUE
