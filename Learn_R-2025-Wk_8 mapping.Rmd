...
<p><strong>Maps in R: Part 1 &ndash; Basics</strong></p>
<p><iframe width="320" height="240" allowfullscreen="allowfullscreen" frameborder="0" src="https://echo360.net.au/media/82aee36b-9476-419f-ba47-b25de5dfb9ef/public?autoplay=false&amp;automute=false"></iframe></p>
<p><strong>The first &asymp;23 minutes are the most useful</strong>. After that, some things have changed, even since 2023! If you want to try <span style="font-family: 'courier new', courier, monospace;">ggmap</span>, my Google Maps API Key will no longer work, and the Stamen maps are sadly no longer available.</p>
</td>
...
<tbody>
<tr>
<td style="width: 50%; background-color: #c0f0f6;"><a href="https://lms.uwa.edu.au/bbcswebdav/pid-3094285-dt-content-rid-40243674_1/xid-40243674_1" target="_blank" rel="noreferrer noopener">![](./images/csv.png){alt="csv file icon" width="32" height="32" align="left"}Ashfield&nbsp;Flats sediment soil data <strong>2020</strong></a></td>
<td valign="top" style="width: 50%; background-color: #c0f0f6;"><a href="https://lms.uwa.edu.au/bbcswebdav/pid-3094285-dt-content-rid-40243112_1/xid-40243112_1" target="_blank" rel="noreferrer noopener">![](./images/rcode.png){alt="R code file icon" width="32" height="32" align="left"}&nbsp;Code used in video(s)</a></td>
</tr>
<tr>
<td valign="top" style="width: 50%; background-color: #c0f0f6;"><a href="https://lms.uwa.edu.au/bbcswebdav/pid-3094285-dt-content-rid-40243004_1/xid-40243004_1">![](./images/csv.png){alt="csv file icon" width="32" height="32" align="left"}>Ashfield Flats sediment soil data 2019</a></td>
<td style="width: 50%; background-color: #c0f0f6;"><a href="https://lms.uwa.edu.au/bbcswebdav/pid-3094285-dt-content-rid-41529282_1/xid-41529282_1" target="_blank" rel="noopener">![](./images/rcode.png){alt="R code file icon" width="32" height="32" align="left"}Code for adding percentile bubbles to maps (tricky!)</a>&nbsp;<strong>UPDATED 2023</strong></td>
</tr>
...
<p><a href="https://raw.githubusercontent.com/Ratey-AtUWA/spatial/main/easy%20peasy%20afr%20map.R" target="_blank" rel="noopener">![](./images/rcode.png){alt="R code file icon" width="32" height="32" align="left"}&nbsp;eezi-peazi Ashfield map (<strong>R</strong> code)</a><br />&nbsp;</p>
<p><a href="https://lms.uwa.edu.au/bbcswebdav/pid-3094285-dt-content-rid-42383985_1/xid-42383985_1" target="_blank" rel="noopener">![](./images/rcode.png){alt="R code file icon" width="32" height="32" align="left"}</a>&nbsp;<a href="https://lms.uwa.edu.au/bbcswebdav/pid-3094285-dt-content-rid-42383985_1/xid-42383985_1" target="_blank" rel="noopener"><strong>R</strong> code to use georeferenced images <em>(e.g</em>. from NearMap) as map backgrounds</a><br />&nbsp;</p>
<p><a href="https://lms.uwa.edu.au/bbcswebdav/pid-3094285-dt-content-rid-42383985_1/xid-42383985_1" target="_blank" rel="noopener">![](./images/rcode.png){alt="R code file icon" width="32" height="32" align="left"}</a>&nbsp;<a href="https://lms.uwa.edu.au/bbcswebdav/pid-3094285-dt-content-rid-42398161_1/xid-42398161_1" target="_blank" rel="noopener">Digitising map features from Google Earth, and R code for a function to convert Google Earth .kml files for use in <strong>R</strong></a></p>
</td>
</tr>
</tbody>
</table>
...
<p><a alt="" href="https://lms.uwa.edu.au/bbcswebdav/pid-3094285-dt-content-rid-41512175_1/xid-41512175_1" target="_blank" rel="noopener">![](./images/html.png){alt="html file icon" width="32" height="32" align="left"}Advanced Spatial Analysis</a><br style="font-family: 'Source Sans Pro'; text-shadow: none; letter-spacing: normal;" />(spatial autocorrelation, variograms, and kriging interpolations)<br />&nbsp;</p>

<p>&nbsp;<a href="https://lms.uwa.edu.au/bbcswebdav/pid-3094285-dt-content-rid-40243094_1/xid-40243094_1" target="_blank">&nbsp;![](./images/pdf.png){alt="pdf file icon" width="32" height="32" align="left"}Annotated&nbsp;R code&nbsp;</a> (2022)<br />&nbsp;</p>

<p> <a href="https://lms.uwa.edu.au/bbcswebdav/pid-3094285-dt-content-rid-40243081_1/xid-40243081_1" target="_blank">![](./images/pdf.png){alt="pdf file icon" width="32" height="32" align="left"}Annotated&nbsp;PowerPoint&nbsp;slides</a>&nbsp;<br style="font-family: 'Source Sans Pro'; text-shadow: none; letter-spacing: normal;" />(old version, but possibly still useful for some things)</p>
</td>
</tr>
</tbody>
</table>
...
pal4liteTransp <- c("black", 
                    viridis::plasma(8, alpha=0.7, beg=0.1),
                    "white")
...
extent <- st_as_sf(data.frame(x=c(399820,400600),y=c(6467920,6468420)),
...
The map tile style we have selected is the default `OpenStreetmap.HOT` style. It
may not be the most attractive style, but it's the best and most simple place to
start.

```{r get_tiles, warning=FALSE, error=FALSE, results='hold'}
# NOTE: projection of input object e.g. 'extent' sets map projection
aftiles <- maptiles::get_tiles(extent, crop = TRUE)
```
...
```{r plot-map1-axes, fig.align='center', fig.cap="Map of Ashfield Flats in the UTM projection, generated using the maptiles R package, with OpenStreetMap tiles.", fig.width=8, fig.height=5.6, message=FALSE, warning=FALSE, out.width='70%', results='hold'}
aftiles <- maptiles::get_tiles(extent, provider = "OpenStreetMap", 
                               crop = TRUE, zoom=16)
par(mar=c(3.5,3.5,2,1.5), mgp=c(1.6,0.2,0), tcl=-0.25, font.lab=2, lend="square")
plot(st_coordinates(extent), asp=1, xaxs="i", yaxs="i",
...
- adjust the height and width of the RStudio `Plots` area to best match the map (*i.e*. no white space around the map tiles raster)
  - (you may need to re-plot after doing this to get the north arrow, scale bar, and legend back in the right position)
...
```{r map-north-scale, fig.align='center', fig.cap="Map of Ashfield Flats (UTM), with added North arrow and scale bar from prettymapr, over OpenStreetMap tiles acquired using maptiles.", fig.height=5.6, fig.width=8, message=FALSE, warning=FALSE, out.width='70%', results='hold',echo=FALSE}
par(mar=c(3.5,3.5,2,1.5), mgp=c(1.6,0.2,0), tcl=-0.25, font.lab=2, lend="square")
plot(st_coordinates(extent), asp=1, xaxs="i", yaxs="i",
     xlab="Easting (UTM Zone 50, m)", ylab="Northing (UTM Zone 50, m)")
plot_tiles(aftiles, add=TRUE) # use axes = TRUE
box()
addnortharrow(text.col=1, border=1)
addscalebar(plotepsg = 32750, label.col = 1, linecol = 1, 
            label.cex = 1.2, htin=0.15, widthhint = 0.15)
...
```{r add-data, eval=TRUE, message=FALSE, warning=FALSE, out.width='70%',echo=FALSE, fig.height=5.6, fig.width=8, fig.cap = "Map of Ashfield Flats (UTM), with added North arrow, scale bar, and user data, over OpenStreetMap tiles acquired using maptiles.", fig.align='center', results='hold'}
par(mar=c(3.5,3.5,2,1.5), mgp=c(1.6,0.2,0), tcl=-0.25, font.lab=2, lend="square")
plot(st_coordinates(extent), asp=1, xaxs="i", yaxs="i",
     xlab="Easting (UTM Zone 50, m)", ylab="Northing (UTM Zone 50, m)")
plot_tiles(aftiles, add=TRUE) # use axes = TRUE
...
with(afr_map, polygon(wetland_E, wetland_N, lwd = 1, lty = 1, 
                      border = "cadetblue", col="#5F9EA080"))
```

```{r map-annot, error=FALSE, warning=FALSE, echo=FALSE, fig.height=5.6, fig.width=8, fig.align='center', out.width="70%", fig.cap="Map of Ashfield Flats (UTM), with added North arrow, scale bar, user data, and additional map items, over OpenStreetMap tiles acquired using maptiles.", results='hold'}
...
text(c(400263, 399962, 400047), c(6468174, 6468083, 6468237),
     ...
     pos = c(2,2,4), cex = 0.8, font = 4, col = "cadetblue")
```

```{r map-text-labels, error=FALSE, warning=FALSE, echo=FALSE, fig.height=5.6, fig.width=8, fig.align='center', out.width="70%", fig.cap="Map of Ashfield Flats (UTM), with added North arrow, scale bar, user data, and additional map items plus text labels, over OpenStreetMap tiles acquired using maptiles.", results='hold'}
# everything we did above in the first line
par(mar=c(3.5,3.5,2,1.5), mgp=c(1.6,0.2,0), tcl=-0.25, font.lab=2, lend="square")
plot(st_coordinates(extent), asp=1, xaxs="i", yaxs="i",
     xlab="Easting (UTM Zone 50, m)", ylab="Northing (UTM Zone 50, m)")
...
factor from the data). A map like that shown in Figure 6 is a good exploratory
...
For the next maps we also make and use a new map tile background
(`provider="CartoDB.Voyager"`) which has a ‘cleaner’ appearance for greater 
clarity.

```{r map-bubbles, fig.align='center', fig.cap="\\label{bubbles}Bubble map of zinc concentrations in sediment and soil at Ashfield Flats in 2019, over CartoDB map tiles acquired using maptiles.", fig.height=5.6, fig.width=8, message=FALSE, warning=FALSE, out.width='70%', results='hold'}
aftiles <- get_tiles(extent, provider="CartoDB.Voyager", zoom=17, crop = TRUE)
...
with(afr_map, polygon(wetland_E, wetland_N, col = "#5F9EA080", 
                    border="cadetblue", lwd = 1, lty = 1))
text(c(400225, 400010, 400045), c(6468200, 6468130, 6468235),
     labels = c("Chapman\nDrain","Kitchener\nDrain","Woolcock\nDrain"),
     pos = c(1,2,4), cex = 0.8, font = 4, col = "cadetblue")
# plot bubbles using the symbols() function
  # first use a simple algoritm to estimate a scale factor for bubbles
...
DGV-high&nbsp;=&nbsp;410&nbsp;mg/kg. The re-drawn map (Figure 7) shows samples
...
```{r map-bubbles-DGV, fig.align='center', fig.cap="Figure 7: Bubble map of zinc concentrations in sediment and soil at Ashfield Flats in 2019, over CartoDB map tiles acquired using maptiles. Locations where Zn concentration exceeds the DGV-high threshold are shown.", fig.height=5.6, fig.width=8, message=FALSE, warning=FALSE, out.width='70%', echo=FALSE}
par(mar=c(3.5,3.5,2,1.5), mgp=c(1.6,0.2,0), tcl=-0.25, font.lab=2, lend="square")
plot(st_coordinates(extent), asp=1, xaxs="i", yaxs="i",
     xlab="Easting (UTM Zone 50, m)", ylab="Northing (UTM Zone 50, m)")
plot_tiles(aftiles, add=TRUE) # use axes = TRUE
...
symbols(c(400480,400480),c(6468060,6468000), circles=s0*sqrt(c(bublo,bubhi)), 
        add=T, lwd=1, inches=F, fg = "purple", bg = "#8000FF40")
points(400480, 6467940, pch=3,lwd=4,col=1)
points(400480, 6467940, pch=3,lwd=2,col=8)
text(c(400480,400510,400510,400490),c(6468120,6468060,6468000,6467940), 
     labels=c("Zn (mg/kg)",bublo,bubhi,"\u2265 DGV-high"), cex=0.85, 
     pos = c(1,4,4,4), font=c(2,1,1,1))
```
...
```{r PctBubb, fig.align='center', fig.cap="Map showing percentile ranges of zinc concentrations in sediment and soil at Ashfield Flats in 2019, over CartoDB map tiles acquired using maptiles.", out.width='70%', fig.height=5.6, fig.width=8, message=FALSE, warning=FALSE, results='hold'}
par(mar=c(3.5,3.5,2,1.5), mgp=c(1.6,0.2,0), tcl=-0.25, font.lab=2, lend="square")
plot(st_coordinates(extent), asp=1, xaxs="i", yaxs="i",
     xlab="Easting (UTM Zone 50, m)", ylab="Northing (UTM Zone 50, m)")
plot_tiles(aftiles, add=TRUE) # use axes = TRUE
...
afs19$QZn <- cut(afs19$Zn, quantile(afs19$Zn, 
                 ...
                 na.rm=T), labels=c("min-Q02","Q02-Q05","Q05-Q25","Q25-Q50",
                                    "Q50-Q75","Q75-Q95","Q95-Q98","Q98-max"))
...
legend("bottomright", legend = rev(levels(afs19$QZn)), 
       ...
       pt.lwd = rev(c(1,1,1,2,2,1,1)), pt.bg = c(2:9), 
       pt.cex = rev(c(0.7,0.9,1.1,1.3,1.3,2,3,4)),
       bty = "n", inset = 0.01, cex = 0.85, 
...
statistical meaning to the bubble sizes. [A similar map](https://ratey-atuwa.github.io/Learn-R-web/maps-location-siteplan.html#Site_Plan_map_with_concentration_classes){target="_blank"}
could be created by using the Tukey boxplot thresholds instead of percentiles
which could show potential outliers (*i.e*. using the `boxplot.stats()` function
to generate categories instead of the `quantile()` function.)
...
variableName`), to generate something like a bubble map. 
...
```{r ggAF, fig.height=4.5, fig.width=7, fig.align='center', fig.cap="Zinc concentration (mg/kg) in sediment sampled in Semester 1, 2021 at Ashfield Flats, Western Australia, plotted over greyscale Google terrain map tiles acquired using the R package ggmap, with data in a simple features data frame, and with manually added wetland pond locations.", out.width='70%', message=FALSE, warning=FALSE, results='hold'}
...
```{r include=FALSE}
secret <- read.csv("tfapi.csv")[1,1]
```

```{r stamen-watercolor, echo=FALSE, fig.align='center', fig.height=2.45, fig.width=8, message=FALSE, warning=FALSE, out.width='80%', results='hold'}
artextent <- st_as_sf(data.frame(x = c(115.795, 115.8905), 
                                 y = c(-31.974, -31.951)),
                      coords=c("x","y"), crs=st_crs(4326))
artStamen2 <- get_tiles(artextent, provider = "Thunderforest.SpinalMap",
                      apikey=secret, zoom=13, crop=TRUE)
par(mar=c(0,0,0,0), oma=c(0,0,0,0))
plot_tiles(artStamen2)
mtext("Thunderforest 'SpinalMap' of Kings Park and Perth", 3, -1.5, 
      col="white", family='mono', cex=1.2)
TeachingDemos::shadowtext(115.89, -31.974, labels="made with sf and maptiles", 
                              col="yellow", pos=2, cex=0.8, family='mono', r=0.2)
TeachingDemos::shadowtext(115.86, -31.966, labels = "Swan River",
                font = 3, srt=350,
            cex = 1.4, hjust = 0.5, col="skyblue2")
text(115.832, -31.966, labels = "Kings\nPark",
       font=3, cex=1.4, col="#f0ff90",srt=10) 
```
