...
The `RColorBrewer::` package contains 35 in-built palettes, 27 of which are
colourblind-friendly (Figure \@ref(fig:rcolorbrewer-cbf)).

```{r rcolorbrewer-cbf, fig.height=8, fig.width=8, message=FALSE, warning=FALSE, fig.align='center', fig.cap="Colourblind-friendly palettes from the `RColorBrewer` R package, showing the maximum number of colours in each palette.", results='hold', echo=2:3}
par(mar=c(0,4,0,0))
